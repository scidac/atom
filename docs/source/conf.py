...
project = 'AToM'
copyright = '2014-'+time.strftime("%Y")+' AToM TEAM'
...
html_theme_options = {
    ...
    # an arbitrary url.
    'navbar_links': [("Research", "research"),
...
man_pages = [
    ('index', 'AToM', 'AToM Documentation', ['AToM team'], 1)
]
...
texinfo_documents = [
  ('index', 'AToM', 'AToM Documentation',
   'AToM documentation', 'AToM', 'Advanced TOkamak Modeling',
   'Integrated modeling'),
]
